...
xcrun swiftc \
    ...
    "$SCRIPT_DIR/DshWebBar.swift" \
    "$SCRIPT_DIR/RuntimeLocatorTests.swift"
...
cp "$SCRIPT_DIR/whale-white.svg" "$APP_PATH/Contents/Resources/whale.svg"
...
cp "$SCRIPT_DIR/安装说明.txt" "$VOLUME_DIR/安装说明.txt"
